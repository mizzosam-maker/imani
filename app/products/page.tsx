...
<div className="flex-1">
  {filteredProducts.length === 0 ? (
    ...
    <>
      ...
      {/*<div className="grid grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-x-5 gap-y-8 sm:gap-x-6 sm:gap-y-10 md:gap-x-8 md:gap-y-12">
        {filteredProducts.map((product) => (
...
<div className="grid grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-y-8 gap-x-2 sm:gap-x-4 md:gap-x-6">
  {filteredProducts.map((product) => (
    <div
      key={product._id}
    ...
    <div className="min-h-screen bg-white">
      <div className="container mx-auto px-3 sm:px-4 py-6 sm:py-8">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
          ...
          <div className="w-full sm:w-auto">
            <input
              ...
              value={searchQuery}
              onChange={(e) => setSearchQuery(e.target.value)}
              className="w-full sm:w-80 md:w-96 px-4 py-2 border border-[#d5c37d] rounded-lg focus:outline-none focus:ring-2 focus:ring-[#e8b924] bg-[#fafaf3] text-sm sm:text-base"
            />
          </div>
          ...
          <button
            onClick={() => setShowFilters(!showFilters)}
            className="md:hidden flex items-center justify-center space-x-2 bg-[#e8b924] text-[#0e0e10] px-4 py-2 rounded-lg w-full sm:w-auto"
          >
            <Filter className="w-4 h-4" />
            <span>Filters</span>
        ...
        <div className="flex flex-col md:flex-row gap-6 md:gap-8">
          ...
          <div className={`md:w-64 ${showFilters ? "block" : "hidden md:block"}`}>
            <div className="bg-[#fcf8d6] p-4 rounded-lg sticky top-24">
              <div className="flex justify-between items-center mb-4">
                ...
                <button
                  onClick={clearFilters}
                  className="text-sm text-[#e8b924] hover:text-[#ddc25d] transition"
                >
                  Clear all
                </button>
              </div>
              ...
              <div className="mb-6">
                ...
                <div className="space-y-2">
                  {categories.map((category) => (
                    <label key={category} className="flex items-center space-x-2 text-sm sm:text-base">
                      <input
                        type="radio"
                        name="category"
                        value={category}
              ...
              {/* Price Range */}
              <div>
                <h3 className="font-medium mb-2 text-sm sm:text-base">Price Range</h3>
                <div className="space-y-2">
                  <input
                    type="range"
                    min="0"
          ...
          {/* Products Grid - Two by two on mobile, responsive on larger screens */}
          <div className="flex-1">
            {filteredProducts.length === 0 ? (
              <div className="text-center py-16">
                <p className="text-lg sm:text-xl text-[#4d4d4d] mb-4">No products found</p>
                <button
                  onClick={clearFilters}
                  className="text-[#e8b924] hover:text-[#ddc25d] transition"
                >
                  Clear filters
                </button>
              </div>
