...
import { useRouter } from "next/navigation";
import Link from "next/link";
import { Package, Users, ShoppingBag, MessageSquare, Plus, Edit, Trash2, Mail } from "lucide-react";
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        <Link 
          href="/admin/products"
          className="bg-[#fcf8d6] p-6 rounded-lg hover:bg-[#f6e9a6] transition cursor-pointer block"
        >
          <div className="flex items-center justify-between mb-4">
            <Package className="w-8 h-8 text-[#e8b924]" />
            <span className="text-2xl font-bold">{stats.totalProducts}</span>
          ...
          <h3 className="font-medium">Total Products</h3>
          <p className="text-sm text-[#4d4d4d] mt-1">Click to manage →</p>
        </Link>
        ...
        >
          ...
          <h3 className="font-medium">Messages</h3>
          <p className="text-sm text-[#4d4d4d] mt-1">Click to view →</p>
        </Link>
      </div>
