            ...
            {(formData.images[0] || formData.name || formData.price) && (
              <div className="space-y-4">
                ...
                <div className="bg-[#fafaf3] p-4 rounded-lg">
                  <p className="text-sm text-[#4d4d4d] mb-2">How your product will appear:</p>
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-[#4d4d4d]">{formData.category || "Category"}</p>
                    </div>
                  </div>
                </div>
              </div>
    ...
    <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-6 sm:mb-8">
          ...
          <p className="text-[#4d4d4d] mt-1">Create a new product with images</p>
        </div>
        ...
        <div className="bg-[#fcf8d6] p-4 sm:p-6 rounded-lg shadow-sm">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            {/* Images - Using Cloudinary Upload Component */}
            <div className="space-y-4">
                ...
                <div className="bg-[#fafaf3] p-4 rounded-lg">
                  ...
                  {formData.images.length > 1 && (
                    <p className="text-xs text-[#4d4d4d] mt-2">
                      +{formData.images.length - 1} more image(s)
                    </p>
                  )}
                </div>
              </div>
